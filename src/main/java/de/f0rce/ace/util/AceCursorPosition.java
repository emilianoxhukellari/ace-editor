...
public class AceCursorPosition {
     ...
     *
     * @param cursorObject {@link ObjectNode}
     */
    public AceCursorPosition(ObjectNode cursorObject) {
        this.row = cursorObject.path("row").asInt();
        this.column = cursorObject.path("column").asInt();
        this.index = cursorObject.path("index").asInt();
    }
